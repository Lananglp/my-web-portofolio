...
export const systemInstructionsText = `
    ...
    If a question is outside the provided information about you, respond with Please check the information about me on the About Me button in the top left corner
`;
