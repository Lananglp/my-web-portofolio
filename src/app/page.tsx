                  ...
                  <div className="grid grid-cols-1 gap-6">
                      ...
                      <table className="w-full">
                        <thead>
                          <tr>
                            ...
                            <th className="px-3 py-1 dark:text-white border border-zinc-300 dark:border-zinc-800 font-medium">Detail</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Name</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">Kadek Lanang Lanusa Putera</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Nickname</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">Lanang</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Age</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">{age} Years Old</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Location</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">Bali, Indonesia</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Characteristics</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">humorous, enthusiastic, intelligent and likes to joke</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Place of birth</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">Antosari</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Year of birth</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">2003</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Age</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">22</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Citizen</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">Indonesia</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Gender</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">Male</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Original address</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">Tabanan, Bali</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Residence address</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">Denpasar, Bali</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Dream</td>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800">Become an astronaut</td>
                          </tr>
                          <tr>
                            <td className="px-3 py-1 border border-zinc-300 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400">Best friends</td>
                    ...
                    <div>
                      ...
                      <ul className="flex flex-col gap-2 text-sm">
                        ...
                        <li><Link href="https://devstone-frontend.vercel.app" target="_blank" className="inline-block bg-zinc-200/50 dark:bg-zinc-800/50 hover:text-blue-400 hover:underline rounded-md px-4 py-2">https://devstone-frontend.vercel.app</Link></li>
                        <li><Link href="https://cylare-learn-router-in-vite.vercel.app" target="_blank" className="inline-block bg-zinc-200/50 dark:bg-zinc-800/50 hover:text-blue-400 hover:underline rounded-md px-4 py-2">https://cylare-learn-router-in-vite.vercel.app</Link></li>
                        <li><Link href="https://cylare-next-app-on-vercel.vercel.app/docs" target="_blank" className="inline-block bg-zinc-200/50 dark:bg-zinc-800/50 hover:text-blue-400 hover:underline rounded-md px-4 py-2">https://cylare-next-app-on-vercel.vercel.app/docs</Link></li>
                      </ul>
                    </div>
                  </div>
                </motion.div>
