    ...
    <AnimatePresence mode="wait">
      {activePage &&
        ...
        >
          ...
          <div className="hidden absolute z-0 pointer-events-none inset-0 md:flex items-center justify-center dark:bg-black bg-transparent [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"/>
              ...
              <div className="h-auto bg-transparent backdrop-blur-sm dark:backdrop-blur-none md:border dark:border-zinc-800 basis-full rounded-xl md:px-6 md:py-6">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                      <h6 className="pb-2 mb-4 border-b border-zinc-300 dark:border-zinc-800 dark:text-white font-medium text-sm">my combat weapon</h6>
                      <div className="grid grid-cols-2 gap-2">
                        <div className="flex items-center gap-1  bg-zinc-200/50 dark:bg-zinc-800 rounded-md p-1">
                        ...
                        <div className="flex items-center gap-1  bg-zinc-950 dark:bg-zinc-800 rounded-md p-1">
