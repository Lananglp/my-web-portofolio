...
import { appVersion } from "@/helper/helper";

const ContentTitle = forwardRef<HTMLHeadingElement, React.ComponentProps<"h6">>(
    ({ className, ...props }, ref) => {
        return (
            <h6
                ref={ref}
                className="pb-2 mb-4 border-b border-neutral-300 font-medium dark:border-neutral-800 dark:text-neutral-300"
                {...props}
            />
        )
    }
...
const MotionContentTitle = motion.create(ContentTitle);
    ...
    return (
        <li>
            <Link
                href={url}
                target="_blank"
                className="overflow-hidden block h-full hover:text-black hover:dark:text-white rounded-xl border border-neutral-300 dark:border-neutral-800"
            >
                <Image
                    src={imageSrc}
                    alt={title}
                    ...
                    quality={70}
                    loading="eager"
                    className="w-full aspect-video object-cover rounded-t-xl border-b border-neutral-300 dark:border-neutral-800"
                />

                <div className="p-4 md:p-6 space-y-1">
                    <h3 className="text-lg font-semibold tracking-tight leading-tight">{title} {isCurrentWebsite && <span className="rounded-full align-middle px-2.5 py-0.5 text-xs border border-border">Current Webite</span>}</h3>
                    <p className="text-xs text-muted-foreground line-clamp-1">{url}</p>
                    <div className="mt-2 flex flex-wrap items-center gap-1">
                        {isProduction && <div className="inline-block rounded-full px-2.5 py-0.5 text-xs bg-green-900 text-white">Production</div>}
                        {inServices && <div className="inline-block rounded-full px-2.5 py-0.5 text-xs bg-blue-900 text-white">In Services</div>}
                        {isRemake && <div className="inline-block rounded-full px-2.5 py-0.5 text-xs bg-purple-900 text-white">Remake</div>}
                        {isDeprecated && <div className="inline-block rounded-full px-2.5 py-0.5 text-xs bg-red-900 text-white">deprecated</div>}
                    </div>
...
export default function Home() {
    ...
    return (
        <AnimatePresence mode="wait">
            {activePage &&
                <motion.div exit={{ opacity: 0 }} transition={{ duration: 0.5 }} className="relative">
                    ...
                    <div className="absolute -z-10 pointer-events-none inset-0 flex items-center justify-center dark:bg-black bg-transparent mask-[radial-gradient(ellipse_at_center,transparent_20%,black)]" />

                    <div className="px-4 pt-4 xl:pt-24 pb-4 container mx-auto max-w-6xl">
                        <div className="flex flex-col md:flex-row gap-0 md:gap-4">
                            <div className="block basis-lg">
                                <div className="md:sticky top-4 xl:top-24">
                                    ...
                                    <div className="bg-transparent md:bg-neutral-100 md:dark:bg-neutral-800/20 backdrop-blur-none md:backdrop-blur-xs md:border dark:border-neutral-800 rounded-xl md:p-6">
                                        ...
                                        <div className="h-32 w-32 mx-auto relative mt-6 md:mt-0">
                                            <motion.div
                                                ...
                                                className="relative text-neutral-700 border border-neutral-800 rounded-full aspect-square"
                                            >
                                                <Image src="/logo.webp" alt="Kadek Lanang Lanusa Putera" width={128} height={128} quality={70} loading="eager" className="w-full h-full object-cover rounded-full" />
                                                {/* <UserRound className="absolute start-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-8 w-8" /> */}
                                            </motion.div>
                                        </div>
                                        <motion.h1 initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.1, type: 'spring', visualDuration: 0.3, bounce: 0.6 }} className="mt-4 dark:text-white text-lg font-medium text-center">Kadek Lanang Lanusa Putera</motion.h1>
                                        <motion.p initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.2, type: 'spring', visualDuration: 0.3, bounce: 0.6 }} className="mb-8 text-sm text-center text-neutral-500 dark:text-neutral-300">lananglanusaputera@gmail.com</motion.p>
                                        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.3, type: 'spring', visualDuration: 0.3, bounce: 0.6 }} className="w-full flex flex-col gap-2 mb-6">
                                        ...
                                        <MotionContentTitle initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.4, type: 'spring', visualDuration: 0.3, bounce: 0.6 }} className="pb-2 mb-4 border-b border-neutral-300 dark:border-neutral-800 dark:text-neutral-400">Social Media</MotionContentTitle>
                                        <ul className="grid grid-cols-2 md:flex md:flex-wrap md:items-center gap-2">
                                            <motion.li initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.5, type: 'spring', visualDuration: 0.3, bounce: 0.6 }}>
                                            ...
                                            <motion.li initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.6, type: 'spring', visualDuration: 0.3, bounce: 0.6 }}>
                                            ...
                                            <motion.li initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.7, type: 'spring', visualDuration: 0.3, bounce: 0.6 }}>
                                            ...
                                            <motion.li initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.8, type: 'spring', visualDuration: 0.3, bounce: 0.6 }}>
                                            ...
                                            <motion.li initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.9, type: 'spring', visualDuration: 0.3, bounce: 0.6 }}>
                                    ...
                                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 1.1, type: 'spring', visualDuration: 0.3, bounce: 0.6 }} className="mt-3 hidden md:flex items-center justify-between">
                                        <ToggleThemeButton />
                                        <span className="text-xs text-muted-foreground">App Version: {appVersion}</span>
                                    </motion.div>
                                </div>
                            </div>
                            <div className="h-auto bg-transparent md:bg-neutral-100 md:dark:bg-neutral-800/20 backdrop-blur-none md:backdrop-blur-xs md:border dark:border-neutral-800 basis-full rounded-xl md:px-6 md:py-6">
                                <div className="hidden md:flex items-center gap-1.5 mb-4">
                                    <div className="w-3 h-3 rounded-full bg-neutral-500 animate-pulse" />
                                    <div className="w-3 h-3 rounded-full bg-neutral-600 animate-pulse delay-150" />
                                    <div className="w-3 h-3 rounded-full bg-neutral-700 animate-pulse delay-300" />
                                ...
                                >
                                    <div className="grid grid-cols-1 gap-6">
                                        {/* Description */}
                                        <section>
                                            <p className="text-neutral-500 dark:text-neutral-300 leading-7">
                                        ...
                                        <section className="space-y-4">
                                            <MotionContentTitle>Programming language</MotionContentTitle>
                                            <div className="grid grid-cols-2 md:flex md:flex-wrap md:items-center gap-2">
                                                <div className="w-full md:w-auto flex items-center gap-1 border border-neutral-300 dark:border-neutral-800 text-black dark:text-white rounded-md px-4 py-2">
                                        ...
                                        {/* Portfolio */}
                                        <section className="space-y-4">
                                            <MotionContentTitle>portfolio project</MotionContentTitle>
                                            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                                                <ProjectCard
                                                    title="AI Chatbot"
                                                    description="AI project for portfolio website, Next + AI SDK Vercel"
                                                    url="https://lananglanusa.my.id/chat"
                                                    imageSrc="/img/ai-chatbot.webp"
                                                    isCurrentWebsite
                                                    isProduction
                                                    inServices
                                                />
                                                <ProjectCard
                                                    title="Cylare App | Fullstack"
                                                    description="Signin with this: email:gila@gila.id | pass:stresngodingleak, Big all in one website, under development, next + better auth + prisma + postgresql"
                                                    url="https://cylare-app.vercel.app/en"
                                                    imageSrc="/img/cylare-app.webp"
                                                    inServices
                                                />
                                                <ProjectCard
                                                    title="Laporan OPGI | PLN"
                                                    description="Web to make my work report at the Main Substation, Next Only"
                                                    url="https://laporan-opgi.vercel.app/"
                                                    imageSrc="/img/laporan-opgi.webp"
                                                    isProduction
                                                    inServices
                                                />
                                                <ProjectCard
                                                    title="Ternak Income"
                                                    description="Signin with this: username:administrator | pass:TernakIncome2025System, Digital product sales website, Laravel 12 + midtrans + postgresql"
                                                    url="https://ternak-income-demo.laravel.cloud/login"
                                                    imageSrc="/img/ternak-income.webp"
                                                    isDeprecated
                                                />
                                                <ProjectCard
                                                    title="Cylare Blog v3"
                                                    description="Signin with this: username:admin@admin.com | pass:User1234_, Website landing page + blog, Next + Tiptap Editor + prisma + postgresql + imagekit"
                                                    url="https://next-blog-v3-delta.vercel.app"
                                                    imageSrc="/img/web-blog-v3.webp"
                                                    isRemake
                                                    isDeprecated
                                                />
                                                <ProjectCard
                                                    title="Rekan Kamu"
                                                    description="A failed project that wanted to build a company management application"
                                                    url="https://next-rekan-kamu.vercel.app/admin"
                                                    imageSrc="/img/rekan-kamu.webp"
                                                    isDeprecated
                                                />
                                                <ProjectCard
                                                    title="Brosur Alfaprima"
                                                    description="Web to display brochures digitally when I was still working at Alfa Prima"
                                                    url="https://brosur.alfaprima.id"
                                                    imageSrc="/img/brosur-alfaprima.webp"
                                                    isProduction
                                                />
                                                <ProjectCard
                                                    title="Ashura Bali"
                                                    description="Failed digital invitation website, but will resume after completing Cylare App | Fullstack"
                                                    url="https://next-ashura-bali.vercel.app"
                                                    imageSrc="/img/ashura-bali.webp"
                                                    isRemake
                                                    isDeprecated
                                                />
                                                <ProjectCard
                                                    title="Design Learn v3"
                                                    description="Learn to design a website part 3"
                                                    url="https://cylare-learn-router-in-vite.vercel.app"
                                                    imageSrc="/img/design-learn-3.webp"
                                                    isDeprecated
                                                />
                                                <ProjectCard
                                                    title="Design Learn v2"
                                                    description="Learn to design a website part 2"
                                                    url="https://devstone-frontend.vercel.app"
                                                    imageSrc="/img/design-learn-2.webp"
                                                    isDeprecated
                                                />
                                                <ProjectCard
                                                    title="Design Learn v1"
                                                    description="Learn to design a website part 1"
                                                    url="https://cylare-next-app-on-vercel.vercel.app"
                                                    imageSrc="/img/design-learn.webp"
                                                    isDeprecated
                                                />
                                            </ul>
                                        </section>
                                        {/* Education */}
                                        <section className="space-y-4">
                                            <MotionContentTitle>Education</MotionContentTitle>
                                            <ul className="flex flex-wrap items-center gap-x-8 gap-y-4 text-neutral-500 dark:text-neutral-300 list-disc pl-4">
                                                {/* <li>
                                        ...
                                        <section className="space-y-4">
                                            <MotionContentTitle>Experience</MotionContentTitle>
                                            <p className="text-neutral-500 dark:text-neutral-300">I have worked at PT. Alfa Prima Sejahtera as an IT Programmer since 2023. Here, I developed a new UI design for the website, created an employee management website, and optimized database performance.</p>
                                            {/* <MotionContentTitle>Side projects</MotionContentTitle>
                                            <p className="text-neutral-500 dark:text-neutral-300">Another project of mine is developing a web application for managing employee management, finance, and attendance within a company. This project is called &quot;Rekan Kamu.&quot; I built this system together with my friend, Dwika.</p> */}
                                            <MotionContentTitle>Hobby</MotionContentTitle>
                                            <p className="text-neutral-500 dark:text-neutral-300">My hobbies include making music using <Link href="https://www.image-line.com/" target="_blank" className="text-black dark:text-white underline underline-offset-4">FL Studio</Link> for about 8 years, playing Mobile Legends, and coding since 2022.</p>
                                            <MotionContentTitle>Other Skills</MotionContentTitle>
                                            <p className="text-neutral-500 dark:text-neutral-300">I also possess skills in audio recording, mixing, and music production using <Link href="https://www.image-line.com/" target="_blank" className="text-black dark:text-white underline underline-offset-4">FL Studio</Link>, allowing me to create professional-quality soundtracks and compositions.</p>
                                            {/* <p className="bg-neutral-200/50 dark:bg-neutral-800/50 rounded-md text-sm p-4">I also possess skills in audio recording, mixing, and music production using <Link href="https://www.image-line.com/" target="_blank" className="text-white underline underline-offset-4">FL Studio</Link>, allowing me to create professional-quality soundtracks and compositions.</p> */}
                                        </section>
                                    </div>
                                </motion.div>
                            </div>
