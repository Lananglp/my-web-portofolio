...
export default function Home() {
  ...
  const scrollToBottomInFullScreen = () => {
  ...
  return (
    <div ref={scrollRef} className="h-screen overflow-y-auto">
      {fullScreen && !isAtBottom && (
        <div
          onClick={scrollToBottomInFullScreen}
          className={`${fullScreen ? 'fixed start-1/2 -translate-x-1/2 bottom-28' : 'absolute end-3 md:end-10 bottom-3 md:bottom-6'} z-10 backdrop-blur-sm bg-zinc-100/75 hover:bg-zinc-100 dark:bg-zinc-800/75 dark:hover:bg-zinc-800 hover:text-black dark:hover:text-white rounded-full shadow-lg p-4 transition duration-200 hover:scale-105 hover:cursor-pointer`}
        >
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className={`${fullScreen ? 'hidden' : liveChat ? 'hidden md:block' : ''} basis-[32rem]`}>
            <div className="sticky top-4 xl:top-24">
              <div className="bg-zinc-100 dark:bg-zinc-900 rounded-xl dark:shadow-lg dark:shadow-black/25 p-6">
                  ...
                  <div className="h-32 w-32 mx-auto relative">
                    {!isTyping &&
                      <motion.div
                        ...
                        className="relative bg-zinc-200 dark:bg-zinc-800 rounded-full dark:shadow-lg dark:shadow-black/25 aspect-square"
                      >
              ...
              {/* <div className="flex items-center mt-3">
                <Switch id="toggle-dark-mode" checked={theme === 'dark'} onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')} className="m-3" />
          ...
          <div className={`${fullScreen ? 'h-screen' : 'h-auto bg-zinc-100 dark:bg-zinc-900 dark:shadow-lg shadow-black/25'} basis-full relative rounded-xl px-2 md:px-6 pt-6 pb-2 md:pb-6`}>
            ...
            {!liveChat ? (
              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="flex items-center gap-1  bg-zinc-200/50 dark:bg-zinc-800 rounded-md dark:shadow-lg dark:shadow-black/25 p-1">
                      ...
                      <div className="flex items-center gap-1  bg-zinc-950 dark:bg-zinc-800 rounded-md dark:shadow-lg dark:shadow-black/25 p-1">
                  ...
                  <div>
                    ...
                    <ul className="flex flex-col gap-2 text-sm">
                      <li><Link href="https://next-rekan-kamu.vercel.app/login" target="_blank" className="inline-block bg-zinc-200/50 dark:bg-zinc-800/50 hover:text-blue-400 hover:underline rounded-md dark:shadow-lg dark:shadow-black/25 px-4 py-2">https://next-rekan-kamu.vercel.app/login</Link></li>
                      <li><Link href="https://next-ashura-bali.vercel.app" target="_blank" className="inline-block bg-zinc-200/50 dark:bg-zinc-800/50 hover:text-blue-400 hover:underline rounded-md dark:shadow-lg dark:shadow-black/25 px-4 py-2">https://next-ashura-bali.vercel.app</Link></li>
                      <li><Link href="https://devstone-frontend.vercel.app" target="_blank" className="inline-block bg-zinc-200/50 dark:bg-zinc-800/50 hover:text-blue-400 hover:underline rounded-md dark:shadow-lg dark:shadow-black/25 px-4 py-2">https://devstone-frontend.vercel.app</Link></li>
                      <li><Link href="https://cylare-learn-router-in-vite.vercel.app" target="_blank" className="inline-block bg-zinc-200/50 dark:bg-zinc-800/50 hover:text-blue-400 hover:underline rounded-md dark:shadow-lg dark:shadow-black/25 px-4 py-2">https://cylare-learn-router-in-vite.vercel.app</Link></li>
                      <li><Link href="https://cylare-next-app-on-vercel.vercel.app/docs" target="_blank" className="inline-block bg-zinc-200/50 dark:bg-zinc-800/50 hover:text-blue-400 hover:underline rounded-md dark:shadow-lg dark:shadow-black/25 px-4 py-2">https://cylare-next-app-on-vercel.vercel.app/docs</Link></li>
                    </ul>
                  </div>
                </div>
              </motion.div>
                ...
                <div className="h-full pt-8">
                  <Button className={`${fullScreen && 'hidden'} absolute top-4 right-6 hover:bg-transparent`} size={'sm'} variant={'ghost'} onClick={() => setLiveChat(false)}><ArrowLeft />Manual Information</Button>
                  <motion.div
                    initial={{ opacity: 0, scale: 0 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{
                    ...
                    className="h-full"
                  >
                    <Chatbot scrollToBottomInFullScreen={scrollToBottomInFullScreen} />
                  </motion.div>
                </div>
                // <AnimatePresence mode="wait">
                //   {fullScreen &&
